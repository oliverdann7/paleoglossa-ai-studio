...
const EXPLANATIONS: TagMap = {
  ...
  verb:         { tag: "verb",         short: "Describes an action, occurrence, or state",                      category: "partOfSpeech" },
  adjective:    { tag: "adjective",    short: "Describes or modifies a noun",                                   category: "partOfSpeech" },
  adverb:       { tag: "adverb",       short: "Modifies a verb, adjective, or another adverb",                  category: "partOfSpeech" },
  pronoun:      { tag: "pronoun",      short: "Stands in for a noun or noun phrase",                            category: "partOfSpeech" },
  preposition:  { tag: "preposition",  short: "Shows relationship between a noun and another word",              category: "partOfSpeech" },
  conjunction:  { tag: "conjunction",  short: "Connects words, phrases, or clauses",                            category: "partOfSpeech" },
  particle:     { tag: "particle",     short: "Uninflected word with a grammatical function",                   category: "partOfSpeech" },
  article:      { tag: "article",      short: "Defines a noun as definite or indefinite",                       category: "partOfSpeech" },
  interjection: { tag: "interjection", short: "Exclamatory word expressing emotion",                            category: "partOfSpeech" },
  numeral:      { tag: "numeral",      short: "A word representing a number",                                   category: "partOfSpeech" },

  // ── Cases ──
  nominative:   { tag: "nominative",   short: "Subject case",                                                   category: "case",
    long: "The nominative case marks the subject of a finite verb or the predicate nominative." },
  genitive:     { tag: "genitive",     short: "Possession, origin, or relationship",                            category: "case",
    long: "The genitive case expresses possession, origin, separation, or a defining relationship between nouns." },
  dative:       { tag: "dative",       short: "Indirect object or instrument",                                  category: "case",
    long: "The dative case marks the indirect object, the instrument of an action, or a location in time or space." },
  accusative:   { tag: "accusative",   short: "Direct object case",                                             category: "case",
  ...
  ablative:     { tag: "ablative",     short: "Separation, source, or means",                                   category: "case",
  ...
  instrumental: { tag: "instrumental", short: "Means or instrument of an action",                               category: "case" },
  ...
  // ── Tenses ──
  present:      { tag: "present",      short: "Ongoing action (imperfective aspect)",                           category: "tense",
    long: "The present tense expresses an ongoing or incomplete action, or a state in the present time." },
  imperfect:    { tag: "imperfect",    short: "Ongoing past action",                                            category: "tense",
  ...
  aorist:       { tag: "aorist",       short: "Simple, undefined past action (perfective aspect)",              category: "tense",
    long: "The aorist tense expresses a simple, completed action without reference to duration or repetition." },
  perfect:      { tag: "perfect",      short: "Completed action with present relevance",                        category: "tense",
    long: "The perfect tense expresses a completed action whose effects continue into the present." },
  pluperfect:   { tag: "pluperfect",   short: "Past action completed before another past event",                category: "tense" },
  futurePerfect: { tag: "futurePerfect", short: "Future action completed before another future event",          category: "tense" },

  // ── Voices ──
  active:       { tag: "active",       short: "Subject performs the action",                                    category: "voice" },
  passive:      { tag: "passive",      short: "Subject receives the action",                                    category: "voice",
    long: "In the passive voice, the subject is the recipient of the action rather than the performer." },
  middle:       { tag: "middle",       short: "Subject participates in or benefits from the action",             category: "voice",
    long: "The middle voice indicates that the subject performs an action that affects itself or is done for its own benefit." },
  medioPassive: { tag: "medioPassive", short: "Middle or passive meaning (context-dependent)",                  category: "voice" },

  // ── Moods ──
  indicative:   { tag: "indicative",   short: "Factual statement or question",                                  category: "mood",
    long: "The indicative mood presents an action or state as a fact, used for statements and questions." },
  subjunctive:  { tag: "subjunctive",  short: "Potential, hypothetical, or wished action",                      category: "mood",
  ...
  optative:     { tag: "optative",     short: "Wish or potential action",                                       category: "mood",
  ...
  participle:   { tag: "participle",   short: "Verbal adjective",                                               category: "mood",
  ...
  qal:          { tag: "qal",          short: "Simple active stem of a Hebrew verb",                            category: "stem",
  ...
  construct:    { tag: "construct",    short: "Bound (construct) state for possession",                         category: "state",
