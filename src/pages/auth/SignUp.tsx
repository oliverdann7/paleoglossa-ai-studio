  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (err.code === 'auth/popup-blocked') {
        ...
        // Ignore user cancellation or duplicate requests
        setError(null);
      } else {
        setError(err.message);
      }
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-16 relative">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <h3 className="text-3xl font-serif font-bold mb-2">{t("auth.createAccount", "Create Account")}</h3>
            ...
            <button 
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-xl border border-black/10 dark:border-white/10 hover:bg-black/5 dark:hover:bg-white/5 disabled:opacity-70 disabled:hover:bg-transparent transition-colors font-medium mb-6"
            >
