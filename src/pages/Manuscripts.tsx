      ...
      <header className="mb-10">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-xs font-bold text-blue tracking-wider uppercase">Experimental</p>
          </div>
        </div>
        <p className="font-body text-[15px] italic text-ink2 mb-8">
          {t(
            'manuscripts.description',
            'Explore manuscript images alongside diplomatic transcriptions and critical apparatus.'
          )}
        </p>
      </header>
      <div className="card p-8 text-center text-muted border-dashed border-2 border-bdr/40 bg-parch2/50">
        <div className="space-y-6">
          <ScanLine className="w-16 h-16 text-muted/60 mx-auto" />
