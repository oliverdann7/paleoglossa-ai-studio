    ...
    <div className="p-6 md:p-12 max-w-6xl mx-auto font-sans min-h-screen">
      <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="font-body text-[16px] text-muted italic mt-1">Your journey through the ancient world continues.</p>
        </div>
        ...
        <div className="flex items-center gap-4">
           ...
           <div className="card p-4 flex items-center gap-4 border-bdr shadow-sm">
              <ProgressRing progress={Math.min(1, stats.readToday / 500)} size={40} />
              <div>
                <div className="text-[14px] font-bold text-ink leading-none">{stats.readToday} / 500</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
        ...
        <div className="lg:col-span-1 rounded-[24px] p-8 bg-blue text-white shadow-xl flex flex-col justify-between min-h-[300px] relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:scale-110 transition-transform">
             <span className="text-[120px] font-serif font-bold leading-none">A</span>
          </div>
        ...
        <div className="lg:col-span-2 card p-8 group cursor-pointer flex flex-col justify-between min-h-[300px] hover:border-blue/30 transition-all border-2 border-transparent" onClick={() => onSelectText(continueText)}>
          ...
          <div className="mt-8">
             <div className="flex justify-between items-end mb-3">
               ...
               <span className="text-[11px] font-bold text-muted uppercase tracking-tighter">~4 mins left in section</span>
             </div>
