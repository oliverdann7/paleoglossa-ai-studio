...
const StatCard = ({ label, value }: { label: string; value: string | number }) => (
  <div className="card px-6 py-5 flex flex-col justify-between hover:shadow-md transition-all h-full">
    <div className="text-[36px] font-serif font-bold mb-1 tracking-tight text-blue">{value}</div>
        ...
        <div className="lg:col-span-1 rounded-[32px] p-8 bg-ink text-parch2 shadow-2xl flex flex-col justify-between min-h-[340px] relative overflow-hidden group">
              ...
              {reviewCount > 0
                ...
                : learningCount > 0
                  ...
                  : t(
                      ...
                      'Read texts and mark words to build your review queue.'
                    )}
            </p>
          </div>
          <button
          ...
          >
            <span className="flex items-center justify-center gap-2">
              {reviewCount > 0
                ? t('dashboard.startReview', 'Enter Review Sanctum')
                : t('dashboard.allCaughtUp', 'No Reviews Today')}
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                {continueText.level && (
                  <span
                    className={cn(
                      'pill',
                      continueText.level === 'A1' || continueText.level === 'A2'
                        ? 'cefr-a'
                        : continueText.level === 'B1' || continueText.level === 'B2'
                          ? 'cefr-b'
                          : 'cefr-c'
                    )}
                  >
            ...
            <div>
              ...
              <p className="font-body text-[15px] text-ink3 leading-relaxed max-w-sm">
                {t(
                  ...
                  'Paste any ancient text and Paleoglossa will analyze it, map it to your vocabulary, and make it readable. Your progress follows your texts.'
                )}
              </p>
            </div>
                  ...
                  <div key={langId} className="card p-5 flex flex-col gap-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[12px] font-bold text-muted">
                        {s.known.toLocaleString()} / {s.total.toLocaleString()}{' '}
                        {t('vocab.known', 'known')}
                      </span>
                    </div>
                    ...
                    <div className="flex gap-4 text-[11px] text-muted font-bold uppercase tracking-wider">
                      <span className="text-amber">
                        {s.learning} {t('vocab.learning', 'learning')}
                      </span>
                      <span className="text-blue">
                        {s.seen} {t('vocab.seen', 'seen')}
                      </span>
                      <span className="ml-auto">
                        {s.masteryPercent}% {t('dashboard.mastered', 'mastered')}
                      </span>
                    </div>
                  </div>
                ))}
        ...
        <div className="mb-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <h4 className="font-serif text-[18px] text-ink mb-1">
                {t('dashboard.importOwn', 'Import Your Own Text')}
              </h4>
              <p className="text-[13px] text-ink3">
                {t(
                  'dashboard.importOwnDesc',
                  'Paste or upload a text. AI will parse morphology and glosses automatically.'
                )}
              </p>
            </button>
            <button
            ...
            >
              ...
              <h4 className="font-serif text-[18px] text-ink mb-1">
                {t('dashboard.exploreLibrary', 'Explore the Library')}
              </h4>
              <p className="text-[13px] text-ink3">
                {t(
                  'dashboard.exploreLibraryDesc',
                  'Browse curated ancient texts in Greek, Hebrew, Latin, and more.'
                )}
              </p>
            </button>
            <button
            ...
            >
              ...
              <h4 className="font-serif text-[18px] text-ink mb-1">
                {t('dashboard.buildLexicon', 'Build Your Lexicon')}
              </h4>
              <p className="text-[13px] text-ink3">
                {t(
                  'dashboard.buildLexiconDesc',
                  'Track words you encounter. Your vocabulary grows as you read.'
                )}
              </p>
            </button>
          </div>
      ...
      <div className="mb-10">
        ...
        {recentVocab.length === 0 ? (
          <EmptyState
            ...
            description={t(
              'dashboard.noVocabHint',
              'Read texts and mark words to build your lexicon.'
            )}
          />
        ) : (
