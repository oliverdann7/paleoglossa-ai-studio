    ...
    <div className="p-6 md:p-12 max-w-5xl mx-auto font-sans min-h-screen">
      ...
      <div className="card p-8 text-center text-muted border-dashed border-2 border-bdr/40 bg-parch2/50">
        <div className="space-y-6">
          <MessageCircle className="w-16 h-16 text-muted/60 mx-auto" />
          <p className="text-ink3 max-w-xl">
            {t('tutor.experimental', 'Conversational AI tutor with context-aware answers — this feature uses your current text and vocabulary to provide personalized help.')}
          </p>
