  ...
  return (
    <div className="p-6 md:p-12 max-w-5xl mx-auto font-sans min-h-screen">
      ...
      <p className="text-ink2 text-[15px] mb-8">
        Check TTS availability and generate pronunciation guides.
      </p>
        ...
        {languages.map((l) => {
          ...
          return (
            <button
              ...
              className={cn(
                'card p-4 text-left hover:border-blue/30 transition-all',
            ...
            {ttsResult.audioUrl ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <audio controls className="flex-1 h-8" src={ttsResult.audioUrl}>
          ...
          <div className="space-y-3">
            ...
            {guideResult.phoneticApproximation && (
              <div className="p-3 bg-parch2 rounded-xl">
                ...
                <span className="text-[14px] text-ink2 italic">
                  {guideResult.phoneticApproximation}
                </span>
              </div>
            )}
