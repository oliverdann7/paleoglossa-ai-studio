    ...
    <div className="p-6 md:p-12 max-w-5xl mx-auto font-sans min-h-screen">
      ...
      <div className="card p-8 text-center text-muted border-dashed border-2 border-bdr/40 bg-parch2/50">
        <div className="space-y-6">
          <GraduationCap className="w-16 h-16 text-muted/60 mx-auto" />
          <p className="text-ink3 max-w-xl">
            {t('grammar.experimental', 'Grammar concept browser with dependency graphs, corpus examples, and SRS integration — this feature uses your actual reading data to personalize learning paths.')}
          </p>
