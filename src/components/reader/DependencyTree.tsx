      ...
      >
        ...
        {rootToken && (() => {
          ...
          return (
            <g key="root-arrow">
              <line
                x1={rx} y1={ROOT_ARROW_HEIGHT} x2={rx} y2={ry - 4}
                stroke={RELATION_COLORS.root} strokeWidth={2}
              />
              <polygon
        ...
        {tokens.map(token => {
          ...
          return (
            ...
            >
              <rect
                x={x} y={tokenTopY}
                width={TOKEN_WIDTH} height={TOKEN_BOX_HEIGHT}
                rx={6}
