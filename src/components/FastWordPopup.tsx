...
export const FastWordPopup = ({
  ...
  const statuses = [
    ...
    },
    {
      ...
      color: 'bg-blue-400/20 text-blue-600 dark:text-blue-300',
    },
    {
      id: 'Learning',
    ...
    },
    {
      ...
      color: 'bg-gold-500/20 text-gold-700 dark:text-gold-400',
    },
    {
      id: 'Known',
    ...
    <AnimatePresence>
      ...
      >
        <div className="p-5 flex flex-col gap-4">
            ...
            <div>
              <h3
                className={cn(
                  ...
                  ['hbo', 'Biblical Hebrew', 'arc', 'Aramaic', 'syr', 'Syriac'].includes(
                    word.language
                  )
                    ? 'font-hebrew'
                    : 'font-greek'
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-obsidian-900/60 dark:text-vellum-100/60 uppercase tracking-widest">
                  {word.lemma}
                </span>
              </div>
            </div>
          ...
          <div className="text-lg italic font-serif opacity-90">"{word.gloss}"</div>
          ...
          <div className="flex justify-between mt-2 pt-4 border-t border-black/5 dark:border-white/5">
            <button
              onClick={onOpenPanel}
              className="text-xs font-bold uppercase tracking-widest text-gold-600 hover:text-gold-500 transition-colors flex items-center gap-1"
            >
