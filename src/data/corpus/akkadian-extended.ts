...
const AKK_LEXICON: Record<string, { lemma: string; gloss: string; partOfSpeech: string }> = {
  ...
  awâtikī: { lemma: 'awātum', gloss: 'your words', partOfSpeech: 'noun' },
  Uruk: { lemma: 'Uruk', gloss: 'Uruk', partOfSpeech: 'noun' },
  bīt: { lemma: 'bītum', gloss: 'house of', partOfSpeech: 'noun' },
  ellim: { lemma: 'ellu', gloss: 'pure', partOfSpeech: 'adjective' },
  Ani: { lemma: 'Anu', gloss: 'Anu', partOfSpeech: 'noun' },
  ašar: { lemma: 'ašru', gloss: 'place where', partOfSpeech: 'noun' },
  gitmālu: { lemma: 'gitmālu', gloss: 'perfect, mighty', partOfSpeech: 'adjective' },
  emūqi: { lemma: 'emūqu', gloss: 'in strength', partOfSpeech: 'noun' },
  ugdašširū: { lemma: 'gašāru', gloss: 'they grew mighty', partOfSpeech: 'verb' },
  eṭlūtim: { lemma: 'eṭlu', gloss: 'of young men', partOfSpeech: 'noun' },
  imsi: { lemma: 'mesû', gloss: 'washed', partOfSpeech: 'verb' },
  dumqi: { lemma: 'dumqu', gloss: 'goodness', partOfSpeech: 'noun' },
  īnāša: { lemma: 'īnu', gloss: 'her eyes', partOfSpeech: 'noun' },
  rubūtu: { lemma: 'rubūtu', gloss: 'lordship', partOfSpeech: 'noun' },
  lū: { lemma: 'lū', gloss: 'truly', partOfSpeech: 'particle' },
  'ḫâʾiri-ma': { lemma: 'ḫāʾiru', gloss: 'her bridegroom', partOfSpeech: 'noun' },
  inbīka: { lemma: 'inbu', gloss: 'your fruit', partOfSpeech: 'noun' },
  yâši: { lemma: 'yāši', gloss: 'to me', partOfSpeech: 'pronoun' },
  qīšam: { lemma: 'qâšu', gloss: 'gift', partOfSpeech: 'noun' },
  qīšma: { lemma: 'qâšu', gloss: 'give!', partOfSpeech: 'verb' },
  pâšu: { lemma: 'pûm', gloss: 'his mouth', partOfSpeech: 'noun' },
  īpušamma: { lemma: 'epēšu', gloss: 'opened/did', partOfSpeech: 'verb' },
  'ḫīrāt-ka': { lemma: 'ḫīrtu', gloss: 'your bride', partOfSpeech: 'noun' },
  aššatu: { lemma: 'aššatu', gloss: 'wife', partOfSpeech: 'noun' },
  attī: { lemma: 'attī', gloss: 'you (f.)', partOfSpeech: 'pronoun' },
  kanūnū: { lemma: 'kanūnu', gloss: 'brazier', partOfSpeech: 'noun' },
  kuṣṣi: { lemma: 'kuṣṣu', gloss: 'cold', partOfSpeech: 'noun' },
  ibellû: { lemma: 'bêlu', gloss: 'shall rule', partOfSpeech: 'verb' },
  šâšu: { lemma: 'šū', gloss: 'that', partOfSpeech: 'pronoun' },
  'pānī-ka': { lemma: 'pānu', gloss: 'your face', partOfSpeech: 'noun' },
  akli: { lemma: 'akālu', gloss: 'eat!', partOfSpeech: 'verb' },
  aššum: { lemma: 'aššum', gloss: 'because', partOfSpeech: 'preposition' },
  baltūti: { lemma: 'baltu', gloss: 'living', partOfSpeech: 'adjective' },
  ibrī: { lemma: 'ibru', gloss: 'my friend', partOfSpeech: 'noun' },
  arāmu: { lemma: 'arāmu', gloss: 'to cover', partOfSpeech: 'verb' },
  dannīš: { lemma: 'dannu', gloss: 'mightily', partOfSpeech: 'adverb' },
  amēlūti: { lemma: 'amēlūtu', gloss: 'of mankind', partOfSpeech: 'noun' },
  bakâku: { lemma: 'bakû', gloss: 'to weep', partOfSpeech: 'verb' },
  mūtu: { lemma: 'mūtu', gloss: 'death', partOfSpeech: 'noun' },
  'eppēš-ma': { lemma: 'epēšu', gloss: 'I shall do', partOfSpeech: 'verb' },
  amâtu: { lemma: 'amātu', gloss: 'word, command', partOfSpeech: 'noun' },
  ḫâliqu: { lemma: 'ḫalāqu', gloss: 'destroying', partOfSpeech: 'verb' },
  iqâbi: { lemma: 'qabû', gloss: 'speaks', partOfSpeech: 'verb' },
  illebbū: { lemma: 'lebû', gloss: 'they twist (?)', partOfSpeech: 'verb' },
  mussa: { lemma: 'mūtu', gloss: 'her husband', partOfSpeech: 'noun' },
};
