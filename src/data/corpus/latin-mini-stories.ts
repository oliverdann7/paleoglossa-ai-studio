...
export const LAT_MINI_1: TextSection = {
  ...
  sentences: [
    ...
    sent(
      'LatMini-1-2',
      ['Villa', 'magna', 'et', 'pulchra', 'est.'],
      'The estate is large and beautiful.'
    ),
    ...
    sent(
      'LatMini-1-7',
      ['Agricola', 'laetus', 'est', 'quod', 'frumentum', 'bonum', 'est.'],
      'The farmer is happy because the grain is good.'
    ),
  ],
};
...
export const LAT_MINI_2: TextSection = {
  ...
  sentences: [
    ...
    sent(
      'LatMini-2-4',
      ['Puer', 'magistrum', 'rogat:', '"Quid', 'est', 'sapientia?"'],
      'The boy asks the teacher: "What is wisdom?"'
    ),
    sent(
      'LatMini-2-5',
      ['Magister', 'respondet:', '"Virtus', 'et', 'scientia."'],
      'The teacher answers: "Virtue and knowledge."'
    ),
    sent('LatMini-2-6', ['Puer', 'audit', 'et', 'discit.'], 'The boy listens and learns.'),
    sent(
      'LatMini-2-7',
      ['Magister', 'gaudet', 'quod', 'puer', 'studiosus', 'est.'],
      'The teacher rejoices because the boy is eager to learn.'
    ),
  ],
};
...
export const LAT_MINI_3: TextSection = {
  ...
  sentences: [
    ...
    sent(
      'LatMini-3-4',
      ['Piscator', 'gaudet', 'et', 'deo', 'gratias', 'agit.'],
    ...
    sent(
      'LatMini-3-7',
      ['Pecuniam', 'accipit', 'et', 'domum', 'redit.'],
      'He receives money and returns home.'
    ),
  ],
};
...
export const LAT_MINI_4: TextSection = {
  ...
  sentences: [
    sent(
      'LatMini-4-1',
      ['Viator', 'ex', 'urbe', 'in', 'alteram', 'urbem', 'iter', 'facit.'],
      'A traveler makes a journey from one city to another.'
    ),
    sent('LatMini-4-2', ['Via', 'longa', 'est.'], 'The road is long.'),
    sent(
      'LatMini-4-3',
      ['Viator', 'fessus', 'est', 'et', 'sitit.'],
      'The traveler is weary and thirsty.'
    ),
    sent(
      'LatMini-4-4',
      ['Fontem', 'invenit', 'et', 'aquam', 'bibit.'],
      'He finds a spring and drinks water.'
    ),
    sent(
      'LatMini-4-5',
      ['Post', 'hoc', 'sub', 'arbore', 'quiescit.'],
      'After this he rests under a tree.'
    ),
    sent(
      'LatMini-4-6',
      ['Sub', 'vesperum', 'in', 'urbem', 'intrat.'],
      'Toward evening he enters the city.'
    ),
...
export const LAT_MINI_5: TextSection = {
  ...
  sentences: [
    ...
    sent(
      'LatMini-5-3',
      ['Una', 'ovis', 'discedit', 'et', 'errат.'],
      'One sheep goes away and wanders.'
    ),
    sent(
      'LatMini-5-4',
      ['Pastor', 'nonaginta', 'novem', 'oves', 'relinquit.'],
      'The shepherd leaves the ninety-nine sheep.'
    ),
    sent(
      'LatMini-5-5',
      ['Ovem', 'errantem', 'quaerit', 'donec', 'inveniat.'],
      'He searches for the wandering sheep until he finds it.'
    ),
    sent('LatMini-5-6', ['Eam', 'invenit', 'et', 'gaudet.'], 'He finds it and rejoices.'),
    sent(
      'LatMini-5-7',
      ['Eam', 'super', 'umeros', 'suos', 'portat.'],
