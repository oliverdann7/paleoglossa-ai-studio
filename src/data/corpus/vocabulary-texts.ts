...
function sent(
  ...
  words: string[],
  translation: string,
  lemmaGloss?: Record<string, { lemma: string; gloss: string }>
): Sentence {
  return {
    id,
...
const VOCAB_COMMON_WORDS = (langPrefix: string) => [
  sent(`${langPrefix}-voc-1`, ['ἄνθρωπος'], 'man / human', {
    ἄνθρωπος: { lemma: 'ἄνθρωπος', gloss: 'man, human' },
  }),
  sent(`${langPrefix}-voc-2`, ['θεός'], 'god', { θεός: { lemma: 'θεός', gloss: 'god' } }),
  sent(`${langPrefix}-voc-3`, ['οἶκος'], 'house', { οἶκος: { lemma: 'οἶκος', gloss: 'house' } }),
  sent(`${langPrefix}-voc-4`, ['λόγος'], 'word', {
    λόγος: { lemma: 'λόγος', gloss: 'word, reason' },
  }),
  ...
  sent(`${langPrefix}-voc-8`, ['οὐρανός'], 'heaven', {
    οὐρανός: { lemma: 'οὐρανός', gloss: 'heaven, sky' },
  }),
  sent(`${langPrefix}-voc-9`, ['μέγας'], 'great', {
    μέγας: { lemma: 'μέγας', gloss: 'great, large' },
  }),
  sent(`${langPrefix}-voc-10`, ['καλός'], 'beautiful', {
    καλός: { lemma: 'καλός', gloss: 'beautiful, good' },
  }),
  sent(`${langPrefix}-voc-11`, ['ἀγαθός'], 'good', { ἀγαθός: { lemma: 'ἀγαθός', gloss: 'good' } }),
  sent(`${langPrefix}-voc-12`, ['πολύς'], 'many', {
    πολύς: { lemma: 'πολύς', gloss: 'many, much' },
  }),
  ...
  sent(`${langPrefix}-voc-18`, ['ποιέω'], 'I make / do', {
    ποιέω: { lemma: 'ποιέω', gloss: 'make, do' },
  }),
  sent(`${langPrefix}-voc-19`, ['λέγω'], 'I say / speak', {
    λέγω: { lemma: 'λέγω', gloss: 'say, speak' },
  }),
  ...
  sent(`${langPrefix}-voc-22`, ['ἔρχομαι'], 'I come / go', {
    ἔρχομαι: { lemma: 'ἔρχομαι', gloss: 'come, go' },
  }),
];
...
const VOCAB_KOINE_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-2`, ['θεός'], 'god', { θεός: { lemma: 'θεός', gloss: 'god' } }),
  sent(`${langPrefix}-voc-3`, ['κύριος'], 'lord', {
    κύριος: { lemma: 'κύριος', gloss: 'lord, master' },
  }),
  sent(`${langPrefix}-voc-4`, ['λόγος'], 'word', {
    λόγος: { lemma: 'λόγος', gloss: 'word, reason' },
  }),
  sent(`${langPrefix}-voc-5`, ['πνεῦμα'], 'spirit', {
    πνεῦμα: { lemma: 'πνεῦμα', gloss: 'spirit, wind' },
  }),
  sent(`${langPrefix}-voc-6`, ['βασιλεία'], 'kingdom', {
    βασιλεία: { lemma: 'βασιλεία', gloss: 'kingdom' },
  }),
  sent(`${langPrefix}-voc-7`, ['ἀγάπη'], 'love', { ἀγάπη: { lemma: 'ἀγάπη', gloss: 'love' } }),
  sent(`${langPrefix}-voc-8`, ['πίστις'], 'faith', {
    πίστις: { lemma: 'πίστις', gloss: 'faith, trust' },
  }),
  sent(`${langPrefix}-voc-9`, ['ἁμαρτία'], 'sin', { ἁμαρτία: { lemma: 'ἁμαρτία', gloss: 'sin' } }),
  sent(`${langPrefix}-voc-10`, ['σῴζω'], 'I save', {
    σῴζω: { lemma: 'σῴζω', gloss: 'save, heal' },
  }),
  sent(`${langPrefix}-voc-11`, ['ἀποστέλλω'], 'I send', {
    ἀποστέλλω: { lemma: 'ἀποστέλλω', gloss: 'send' },
  }),
  sent(`${langPrefix}-voc-12`, ['γινώσκω'], 'I know', {
    γινώσκω: { lemma: 'γινώσκω', gloss: 'know' },
  }),
  sent(`${langPrefix}-voc-13`, ['ἀκούω'], 'I hear', {
    ἀκούω: { lemma: 'ἀκούω', gloss: 'hear, listen' },
  }),
  sent(`${langPrefix}-voc-14`, ['γράφω'], 'I write', { γράφω: { lemma: 'γράφω', gloss: 'write' } }),
  sent(`${langPrefix}-voc-15`, ['δίκαιος'], 'righteous', {
    δίκαιος: { lemma: 'δίκαιος', gloss: 'righteous, just' },
  }),
  ...
  sent(`${langPrefix}-voc-18`, ['γυνή'], 'woman / wife', {
    γυνή: { lemma: 'γυνή', gloss: 'woman, wife' },
  }),
  sent(`${langPrefix}-voc-19`, ['ἀνήρ'], 'man / husband', {
    ἀνήρ: { lemma: 'ἀνήρ', gloss: 'man, husband' },
  }),
  sent(`${langPrefix}-voc-20`, ['τέκνον'], 'child', {
    τέκνον: { lemma: 'τέκνον', gloss: 'child' },
  }),
];
...
const VOCAB_LATIN_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-4`, ['terra'], 'earth', {
    terra: { lemma: 'terra', gloss: 'earth, land' },
  }),
  sent(`${langPrefix}-voc-5`, ['caelum'], 'heaven', {
    caelum: { lemma: 'caelum', gloss: 'heaven, sky' },
  }),
  ...
  sent(`${langPrefix}-voc-8`, ['domus'], 'house', {
    domus: { lemma: 'domus', gloss: 'house, home' },
  }),
  ...
  sent(`${langPrefix}-voc-17`, ['magnus'], 'great', {
    magnus: { lemma: 'magnus', gloss: 'great, large' },
  }),
  sent(`${langPrefix}-voc-18`, ['parvus'], 'small', {
    parvus: { lemma: 'parvus', gloss: 'small' },
  }),
  ...
  sent(`${langPrefix}-voc-21`, ['facio'], 'I make', {
    facio: { lemma: 'facio', gloss: 'make, do' },
  }),
...
const VOCAB_HEBREW_WORDS = (langPrefix: string) => [
  sent(`${langPrefix}-voc-1`, ['אָדָם'], 'man / human', {
    אָדָם: { lemma: 'אָדָם', gloss: 'man, human' },
  }),
  sent(`${langPrefix}-voc-2`, ['אִשָּׁה'], 'woman', {
    אִשָּׁה: { lemma: 'אִשָּׁה', gloss: 'woman, wife' },
  }),
  sent(`${langPrefix}-voc-3`, ['אֱלֹהִים'], 'God', {
    אֱלֹהִים: { lemma: 'אֱלֹהִים', gloss: 'God' },
  }),
  sent(`${langPrefix}-voc-4`, ['מֶלֶךְ'], 'king', { מֶלֶךְ: { lemma: 'מֶלֶךְ', gloss: 'king' } }),
  sent(`${langPrefix}-voc-5`, ['אֶרֶץ'], 'earth / land', {
    אֶרֶץ: { lemma: 'אֶרֶץ', gloss: 'earth, land' },
  }),
  sent(`${langPrefix}-voc-6`, ['שָׁמַיִם'], 'heaven', {
    שָׁמַיִם: { lemma: 'שָׁמַיִם', gloss: 'heaven, sky' },
  }),
  ...
  sent(`${langPrefix}-voc-15`, ['רַע'], 'bad / evil', {
    רַע: { lemma: 'רַע', gloss: 'bad, evil' },
  }),
  sent(`${langPrefix}-voc-16`, ['יָד'], 'hand', { יָד: { lemma: 'יָד', gloss: 'hand' } }),
  sent(`${langPrefix}-voc-17`, ['דָּבָר'], 'word / thing', {
    דָּבָר: { lemma: 'דָּבָר', gloss: 'word, thing' },
  }),
  sent(`${langPrefix}-voc-18`, ['כֹּל'], 'all', { כֹּל: { lemma: 'כֹּל', gloss: 'all, every' } }),
  sent(`${langPrefix}-voc-19`, ['גָּדוֹל'], 'great', {
    גָּדוֹל: { lemma: 'גָּדוֹל', gloss: 'great, large' },
  }),
  sent(`${langPrefix}-voc-20`, ['קָדוֹשׁ'], 'holy', {
    קָדוֹשׁ: { lemma: 'קָדוֹשׁ', gloss: 'holy' },
  }),
];
...
const VOCAB_SYRIAC_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-4`, ['ܫܡܝܐ'], 'heaven', {
    ܫܡܝܐ: { lemma: 'ܫܡܝܐ', gloss: 'heaven, sky' },
  }),
...
const VOCAB_COPTIC_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-2`, ['ⲣⲱⲙⲉ'], 'man / human', {
    ⲣⲱⲙⲉ: { lemma: 'ⲣⲱⲙⲉ', gloss: 'man, human' },
  }),
  sent(`${langPrefix}-voc-3`, ['ⲥϩⲓⲙⲉ'], 'woman', {
    ⲥϩⲓⲙⲉ: { lemma: 'ⲥϩⲓⲙⲉ', gloss: 'woman, wife' },
  }),
  ...
  sent(`${langPrefix}-voc-10`, ['ⲥⲱⲧⲙ'], 'to hear', {
    ⲥⲱⲧⲙ: { lemma: 'ⲥⲱⲧⲙ', gloss: 'hear, obey' },
  }),
  sent(`${langPrefix}-voc-11`, ['ⲛⲁⲩ'], 'to see', { ⲛⲁⲩ: { lemma: 'ⲛⲁⲩ', gloss: 'see, behold' } }),
  sent(`${langPrefix}-voc-12`, ['ⲉⲓ'], 'to come', { ⲉⲓ: { lemma: 'ⲉⲓ', gloss: 'come' } }),
  sent(`${langPrefix}-voc-13`, ['ⲉⲓⲣⲉ'], 'to make / do', {
    ⲉⲓⲣⲉ: { lemma: 'ⲉⲓⲣⲉ', gloss: 'make, do' },
  }),
  sent(`${langPrefix}-voc-14`, ['ϫⲟⲟ'], 'to say', { ϫⲟⲟ: { lemma: 'ϫⲟⲟ', gloss: 'say, speak' } }),
  sent(`${langPrefix}-voc-15`, ['ⲛⲁϣⲧ'], 'to be great', {
    ⲛⲁϣⲧ: { lemma: 'ⲛⲁϣⲧ', gloss: 'great, mighty' },
  }),
];
...
const VOCAB_ARAMAIC_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-2`, ['מַלְכָּא'], 'king', {
    מַלְכָּא: { lemma: 'מַלְכָּא', gloss: 'king' },
  }),
  sent(`${langPrefix}-voc-3`, ['אַרְעָא'], 'earth', {
    אַרְעָא: { lemma: 'אַרְעָא', gloss: 'earth, land' },
  }),
  sent(`${langPrefix}-voc-4`, ['שְׁמַיָּא'], 'heaven', {
    שְׁמַיָּא: { lemma: 'שְׁמַיָּא', gloss: 'heaven, sky' },
  }),
  sent(`${langPrefix}-voc-5`, ['מַיָּא'], 'water', { מַיָּא: { lemma: 'מַיָּא', gloss: 'water' } }),
  sent(`${langPrefix}-voc-6`, ['נְהוֹרָא'], 'light', {
    נְהוֹרָא: { lemma: 'נְהוֹרָא', gloss: 'light' },
  }),
  sent(`${langPrefix}-voc-7`, ['חֲשׁוֹכָא'], 'darkness', {
    חֲשׁוֹכָא: { lemma: 'חֲשׁוֹכָא', gloss: 'darkness' },
  }),
  sent(`${langPrefix}-voc-8`, ['בְּרָא'], 'son', { בְּרָא: { lemma: 'בְּרָא', gloss: 'son' } }),
  sent(`${langPrefix}-voc-9`, ['אַבָּא'], 'father', {
    אַבָּא: { lemma: 'אַבָּא', gloss: 'father' },
  }),
  sent(`${langPrefix}-voc-10`, ['חֶלְמָא'], 'dream', {
    חֶלְמָא: { lemma: 'חֶלְמָא', gloss: 'dream' },
  }),
  sent(`${langPrefix}-voc-11`, ['חָכְמְתָא'], 'wisdom', {
    חָכְמְתָא: { lemma: 'חָכְמְתָא', gloss: 'wisdom' },
  }),
  sent(`${langPrefix}-voc-12`, ['טָב'], 'good', { טָב: { lemma: 'טָב', gloss: 'good' } }),
  sent(`${langPrefix}-voc-13`, ['רַב'], 'great', { רַב: { lemma: 'רַב', gloss: 'great, large' } }),
  sent(`${langPrefix}-voc-14`, ['עַבְדָּא'], 'servant', {
    עַבְדָּא: { lemma: 'עַבְדָּא', gloss: 'servant, slave' },
  }),
  sent(`${langPrefix}-voc-15`, ['מִלְּתָא'], 'word', {
    מִלְּתָא: { lemma: 'מִלְּתָא', gloss: 'word, thing' },
  }),
];
...
const VOCAB_AKKADIAN_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-4`, ['bītum'], 'house', {
    bītum: { lemma: 'bītum', gloss: 'house, temple' },
  }),
  sent(`${langPrefix}-voc-5`, ['mātum'], 'land', {
    mātum: { lemma: 'mātum', gloss: 'land, country' },
  }),
  sent(`${langPrefix}-voc-6`, ['ālum'], 'city', { ālum: { lemma: 'ālum', gloss: 'city' } }),
  sent(`${langPrefix}-voc-7`, ['šamû'], 'heaven', {
    šamû: { lemma: 'šamû', gloss: 'heaven, sky' },
  }),
  ...
  sent(`${langPrefix}-voc-11`, ['ṣīḫum'], 'laughter', {
    ṣīḫum: { lemma: 'ṣīḫum', gloss: 'laughter' },
  }),
  sent(`${langPrefix}-voc-12`, ['ṭābum'], 'good', { ṭābum: { lemma: 'ṭābum', gloss: 'good' } }),
  sent(`${langPrefix}-voc-13`, ['rabûm'], 'great', {
    rabûm: { lemma: 'rabûm', gloss: 'great, large' },
  }),
  sent(`${langPrefix}-voc-14`, ['qabûm'], 'to speak', {
    qabûm: { lemma: 'qabûm', gloss: 'speak, say' },
  }),
  sent(`${langPrefix}-voc-15`, ['alākum'], 'to go', {
    alākum: { lemma: 'alākum', gloss: 'go, come' },
  }),
];
...
const VOCAB_HITTITE_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-5`, ['ÉRINMEŠ'], 'troops', {
    ÉRINMEŠ: { lemma: 'ÉRINMEŠ', gloss: 'troops, army' },
  }),
  ...
  sent(`${langPrefix}-voc-9`, ['LUGAL.GAL'], 'great king', {
  ...
  sent(`${langPrefix}-voc-13`, ['uwa-'], 'to come', {
    'uwa-': { lemma: 'uwa-', gloss: 'to come' },
  }),
  sent(`${langPrefix}-voc-14`, ['ḫar-'], 'to have', {
    'ḫar-': { lemma: 'ḫar-', gloss: 'to have, hold' },
  }),
...
const VOCAB_UGARITIC_WORDS = (langPrefix: string) => [
  sent(`${langPrefix}-voc-1`, ['𐎁𐎓𐎍'], 'Baal / lord', {
    '𐎁𐎓𐎍': { lemma: '𐎁𐎓𐎍', gloss: 'Baal, lord, master' },
  }),
  ...
  sent(`${langPrefix}-voc-5`, ['𐎃𐎐'], 'to be gracious', {
    '𐎃𐎐': { lemma: '𐎃𐎐', gloss: 'to be gracious' },
  }),
  ...
  sent(`${langPrefix}-voc-8`, ['𐎋𐎒𐎀'], 'throne', {
    '𐎋𐎒𐎀': { lemma: '𐎋𐎒𐎀', gloss: 'throne, seat' },
  }),
  ...
  sent(`${langPrefix}-voc-12`, ['𐎋𐎁𐎄'], 'liver / honor', {
    '𐎋𐎁𐎄': { lemma: '𐎋𐎁𐎄', gloss: 'liver, honor, weighty' },
  }),
  sent(`${langPrefix}-voc-13`, ['𐎎𐎅'], 'what?', { '𐎎𐎅': { lemma: '𐎎𐎅', gloss: 'what?' } }),
  sent(`${langPrefix}-voc-14`, ['𐎌𐎐𐎀'], 'to hate', { '𐎌𐎐𐎀': { lemma: '𐎌𐎐𐎀', gloss: 'to hate' } }),
  sent(`${langPrefix}-voc-15`, ['𐎂𐎗'], 'to attack', {
    '𐎂𐎗': { lemma: '𐎂𐎗', gloss: 'to attack, fight' },
  }),
];
...
const VOCAB_SANSKRIT_WORDS = (langPrefix: string) => [
  sent(`${langPrefix}-voc-1`, ['धर्म'], 'dharma / duty', {
    धर्म: { lemma: 'धर्म', gloss: 'dharma, law, duty' },
  }),
  sent(`${langPrefix}-voc-2`, ['कर्म'], 'action / karma', {
    कर्म: { lemma: 'कर्म', gloss: 'action, karma' },
  }),
  sent(`${langPrefix}-voc-3`, ['अर्थ'], 'wealth / meaning', {
    अर्थ: { lemma: 'अर्थ', gloss: 'wealth, purpose, meaning' },
  }),
  sent(`${langPrefix}-voc-4`, ['मोक्ष'], 'liberation', {
    मोक्ष: { lemma: 'मोक्ष', gloss: 'liberation, release' },
  }),
  sent(`${langPrefix}-voc-5`, ['आत्मन्'], 'self / soul', {
    आत्मन्: { lemma: 'आत्मन्', gloss: 'self, soul, atman' },
  }),
  sent(`${langPrefix}-voc-6`, ['ब्रह्मन्'], 'Brahman', {
    ब्रह्मन्: { lemma: 'ब्रह्मन्', gloss: 'Brahman, ultimate reality' },
  }),
  sent(`${langPrefix}-voc-7`, ['देव'], 'god', { देव: { lemma: 'देव', gloss: 'god, deity' } }),
  sent(`${langPrefix}-voc-8`, ['मनुष्य'], 'human', {
    मनुष्य: { lemma: 'मनुष्य', gloss: 'human, man' },
  }),
  sent(`${langPrefix}-voc-9`, ['राजन्'], 'king', { राजन्: { lemma: 'राजन्', gloss: 'king' } }),
  sent(`${langPrefix}-voc-10`, ['गुरु'], 'teacher', {
    गुरु: { lemma: 'गुरु', gloss: 'teacher, guru, heavy' },
  }),
  sent(`${langPrefix}-voc-11`, ['शिष्य'], 'disciple', {
    शिष्य: { lemma: 'शिष्य', gloss: 'disciple, student' },
  }),
  sent(`${langPrefix}-voc-12`, ['प्रेमन्'], 'love', {
    प्रेमन्: { lemma: 'प्रेमन्', gloss: 'love' },
  }),
  sent(`${langPrefix}-voc-13`, ['ज्ञान'], 'knowledge', {
    ज्ञान: { lemma: 'ज्ञान', gloss: 'knowledge, wisdom' },
  }),
  sent(`${langPrefix}-voc-14`, ['शान्ति'], 'peace', {
    शान्ति: { lemma: 'शान्ति', gloss: 'peace, tranquility' },
  }),
...
const VOCAB_EGYPTIAN_WORDS = (langPrefix: string) => [
  ...
  sent(`${langPrefix}-voc-2`, ['rmṯ'], 'people', {
    rmṯ: { lemma: 'rmṯ', gloss: 'people, mankind' },
  }),
  sent(`${langPrefix}-voc-3`, ['pr'], 'house', {
    pr: { lemma: 'pr', gloss: 'house, temple, domain' },
  }),
  ...
  sent(`${langPrefix}-voc-8`, ['nfr'], 'good / beautiful', {
    nfr: { lemma: 'nfr', gloss: 'good, beautiful, perfect' },
  }),
  sent(`${langPrefix}-voc-9`, ['ˁnḫ'], 'life / live', {
    ˁnḫ: { lemma: 'ˁnḫ', gloss: 'life, to live' },
  }),
  sent(`${langPrefix}-voc-10`, ['mȝˁt'], 'truth / order', {
    mȝˁt: { lemma: 'mȝˁt', gloss: 'truth, justice, Maat' },
  }),
  sent(`${langPrefix}-voc-11`, ['ỉr'], 'to make / do', {
    ỉr: { lemma: 'ỉr', gloss: 'to make, to do' },
  }),
  sent(`${langPrefix}-voc-12`, ['ḏd'], 'to say', { ḏd: { lemma: 'ḏd', gloss: 'to say, speak' } }),
  sent(`${langPrefix}-voc-13`, ['m'], 'in / from / as', {
    m: { lemma: 'm', gloss: 'in, from, as, with' },
  }),
  sent(`${langPrefix}-voc-14`, ['n'], 'to / for / of', {
    n: { lemma: 'n', gloss: 'to, for, of, belonging to' },
  }),
  sent(`${langPrefix}-voc-15`, ['ỉw'], 'and / while', {
    ỉw: { lemma: 'ỉw', gloss: 'and, while, (auxiliary)' },
  }),
];
