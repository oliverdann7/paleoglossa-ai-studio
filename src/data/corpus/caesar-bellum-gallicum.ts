...
export const CAESAR_BELLUM_GALLICUM_1: TextSection = {
  ...
  sentences: [
    ...
    sent(
      ...
      'The Helvetii begin from the furthest borders of Gaul; the Pyrenees mountains separate Spain from Gaul; the Rhine river separates Italy from Gaul;'
    ),
    sent(
      'Caes-1-4',
      [
      ...
      'the borders of Gaul are on one side the Ocean, on the other the Rhine river.'
    ),
    sent(
      'Caes-1-5',
      ['Helvetii', 'sunt', 'sinistra', 'in', 'Germaniam', 'Rhenumque.'],
      'The Helvetii are on the left toward Germany and the Rhine.'
    ),
    sent(
      'Caes-1-6',
      [
    ...
    sent(
      'Caes-1-7',
      ['idem', 'erat', 'cupiditate', 'incensi', 'ut', 'ex', 'suis', 'finibus', 'exirent.'],
      'They were inflamed with the desire to depart from their own borders.'
    ),
    sent(
      'Caes-1-8',
      [
    ...
    sent(
      'Caes-1-9',
      ['neque', 'animum', 'suum', 'cupiditate', 'imperii', 'et', 'gloriae', 'poterat', 'moderari.'],
      'nor could they moderate the desire for dominion and glory.'
    ),
    sent(
      'Caes-1-10',
      [
    ...
    sent(
      'Caes-1-11',
      ['Helvetii', 'se', 'in', 'Sequanos', 'contulerunt,', 'inde', 'in', 'Haeduos', 'devenerunt.'],
      'The Helvetii went to the Sequani, and thence came to the Aedui.'
    ),
    sent(
      'Caes-1-12',
      ['populi', 'Elvetii', 'multum', 'negotii', 'nobis', 'praebuerunt.'],
      'The Swiss people caused us much trouble.'
    ),
  ],
};
...
export const CAESAR_BELLUM_GALLICUM_2: TextSection = {
  ...
  sentences: [
    sent(
      ...
      'This matter was among the Helvetii in view of two great virtues: because neither the land was sufficient nor could they coexist.'
    ),
    sent(
      'Caes-2-2',
      ['omnibusque', 'civitatum', 'viros', 'idoneos', 'collegit', 'Orgetorix.'],
      'Orgetorix gathered all the fit men of the states.'
    ),
    sent(
      'Caes-2-3',
      [
      ...
      'While he himself sought to seize the highest power, he provided aid to the peoples.'
    ),
    sent(
      'Caes-2-4',
      ['ea', 'tempestate', 'Caesar', 'erat', 'in', 'Gallia', 'constitutus.'],
    ...
    sent(
      'Caes-2-6',
      ['is', 'enim', 'populus', 'erat', 'potens', 'et', 'ferocissimus.'],
      'For that people was powerful and very fierce.'
    ),
    sent(
      'Caes-2-7',
      ['exercitus', 'noster', 'erat', 'proximus', 'Helvetiis.'],
      'Our army was near the Helvetii.'
    ),
    sent(
      'Caes-2-8',
      ['sed', 'hostiles', 'copiis', 'nostras', 'in', 'montibus', 'superabant.'],
      'But the enemy forces surpassed ours in the mountains.'
    ),
    sent(
      'Caes-2-9',
      ['tamen', 'Caesar', 'exercitum', 'adhibuit', 'et', 'pugnam', 'commitendum', 'censuit.'],
      'Nevertheless, Caesar applied his army and decided battle must be joined.'
    ),
    sent(
      'Caes-2-10',
      ['acerba', 'pugna', 'fuit', 'in', 'eo', 'loco.'],
      'A fierce battle occurred in that place.'
    ),
    sent(
      'Caes-2-11',
      ['Helvetii', 'tamen', 'cesserunt', 'et', 'in', 'montes', 'se', 'receperunt.'],
      'Nevertheless, the Helvetii yielded and withdrew to the mountains.'
    ),
    sent(
      'Caes-2-12',
      ['nostri', 'victoriam', 'reportaverunt', 'et', 'castra', 'Helvetiorum', 'occupaverunt.'],
      'Our men gained victory and occupied the camp of the Helvetii.'
    ),
  ],
};
...
export const CAESAR_BELLUM_GALLICUM_3: TextSection = {
  ...
  sentences: [
    sent(
      'Caes-3-1',
      ['post', 'hunc', 'eventum', 'Caesar', 'Helvetios', 'persequi', 'statuit.'],
      'After this event, Caesar decided to pursue the Helvetii.'
    ),
    sent(
      'Caes-3-2',
      ['nec', 'enim', 'facile', 'erat', 'eos', 'sinere', 'in', 'Galliam', 'permanere.'],
    ...
    sent(
      'Caes-3-4',
      ['Ariovistus', 'erat', 'rex', 'Germanorum', 'potens', 'et', 'bellicosus.'],
      'Ariovistus was a powerful and warlike king of the Germans.'
    ),
    sent(
      'Caes-3-5',
      ['petit', 'ab', 'eo', 'ut', 'pacem', 'faciat', 'Helvetiis.'],
      'He asked him to make peace with the Helvetii.'
    ),
    sent(
      'Caes-3-6',
      ['Caesar', 'responderat', 'se', 'velle', 'pacem.'],
      'Caesar replied that he wished for peace.'
    ),
    sent(
      'Caes-3-7',
      ['sed', 'Ariovistus', 'nihilominus', 'malus', 'erat', 'et', 'contentiosus.'],
      'But Ariovistus was nevertheless hostile and contentious.'
    ),
    sent(
      'Caes-3-8',
      ['itaque', 'Caesar', 'vidit', 'se', 'debere', 'cum', 'Ariovisto', 'pugnare.'],
      'Therefore Caesar saw that he must fight with Ariovistus.'
    ),
    sent(
      'Caes-3-9',
      ['exercitus', 'Germanorum', 'erat', 'ingens.'],
      'The army of the Germans was huge.'
    ),
    sent(
      'Caes-3-10',
      ['numerus', 'militum', 'nostri', 'exercitus', 'erat', 'multo', 'minor.'],
      'The number of soldiers in our army was much smaller.'
    ),
    sent(
      'Caes-3-11',
      ['tamen', 'Caesar', 'diffidentia', 'non', 'afficiebatur.'],
      'Nevertheless, Caesar was not affected by lack of confidence.'
    ),
    sent(
      'Caes-3-12',
      ['pugna', 'cum', 'Ariovisto', 'erat', 'necessaria', 'et', 'urgente.'],
      'Battle with Ariovistus was necessary and urgent.'
    ),
  ],
};
