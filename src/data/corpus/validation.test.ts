...
describe('corpus production data', () => {
  ...
  const KNOWN_VALIDATE_CORPUS_ERRORS = new Set<string>([
    ...
    'Text "LXX-Ps-33" is marked complete but has annotation gaps: 28 unknown POS, 28 missing gloss, 0 missing lemma (of 131 tokens). Either complete the annotations or change sourceStatus to \'partial\'.',
    'Text "LXX-Exod-12" is marked complete but has annotation gaps: 95 unknown POS, 95 missing gloss, 0 missing lemma (of 424 tokens). Either complete the annotations or change sourceStatus to \'partial\'.',
    'Text "LXX-Isa-6" is marked complete but has annotation gaps: 42 unknown POS, 42 missing gloss, 0 missing lemma (of 208 tokens). Either complete the annotations or change sourceStatus to \'partial\'.',
    'Text "LXX-Prov-1" is marked complete but has annotation gaps: 51 unknown POS, 51 missing gloss, 0 missing lemma (of 109 tokens). Either complete the annotations or change sourceStatus to \'partial\'.',
    'Text "LXX-Ps-50" is marked complete but has annotation gaps: 43 unknown POS, 43 missing gloss, 0 missing lemma (of 165 tokens). Either complete the annotations or change sourceStatus to \'partial\'.',
    'Text "LXX-Jonah-1" is marked complete but has annotation gaps: 62 unknown POS, 62 missing gloss, 0 missing lemma (of 308 tokens). Either complete the annotations or change sourceStatus to \'partial\'.',
