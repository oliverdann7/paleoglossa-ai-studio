...
export const texts: TextMetadata[] = [
  // Greek
  { id: 101, title: "Greek Alphabet & Sounds", author: "Foundations", language: "Greek", level: "A1", era: "Ancient", image: "https://images.unsplash.com/photo-1544640808-32ca72ac7f37?auto=format&fit=crop&q=80&w=400", knownCoverage: 98, unknownLemmas: 1, learningWords: 0 },
  { id: 102, title: "Basic Greetings & Phrasing", author: "Foundations", language: "Greek", level: "A1", era: "Ancient", image: "https://images.unsplash.com/photo-1544640808-32ca72ac7f37?auto=format&fit=crop&q=80&w=400", knownCoverage: 85, unknownLemmas: 4, learningWords: 2 },
  { id: 103, title: "Aesop's Fables", author: "Aesop", language: "Greek", level: "A2", era: "6th c. BC", image: "https://images.unsplash.com/photo-1474932430478-367dbb6832c1?auto=format&fit=crop&q=80&w=400", knownCoverage: 72, unknownLemmas: 15, learningWords: 8 },
  { id: 104, title: "Gospel of John", author: "John", language: "Greek", level: "B1", era: "1st c. AD", image: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?auto=format&fit=crop&q=80&w=400", knownCoverage: 64, unknownLemmas: 40, learningWords: 22 },
  { id: 105, title: "Anabasis", author: "Xenophon", language: "Greek", level: "B2", era: "4th c. BC", image: "https://images.unsplash.com/photo-1474932430478-367dbb6832c1?auto=format&fit=crop&q=80&w=400", knownCoverage: 45, unknownLemmas: 120, learningWords: 35 },
  { id: 106, title: "Iliad", author: "Homer", language: "Greek", level: "C1", era: "8th c. BC", image: "https://images.unsplash.com/photo-1474932430478-367dbb6832c1?auto=format&fit=crop&q=80&w=400", knownCoverage: 30, unknownLemmas: 400, learningWords: 80 },
  { id: 107, title: "The Odyssey", author: "Homer", language: "Greek", level: "C2", era: "8th c. BC", image: "https://images.unsplash.com/photo-1544640808-32ca72ac7f37?auto=format&fit=crop&q=80&w=400", knownCoverage: 28, unknownLemmas: 420, learningWords: 85 },
  
  // Hebrew
  { id: 201, title: "The Aleph-Bet & Vowels", author: "Foundations", language: "Hebrew", level: "A1", era: "Ancient", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 100, unknownLemmas: 0, learningWords: 0 },
  { id: 202, title: "Basic Vocabulary", author: "Foundations", language: "Hebrew", level: "A1", era: "Ancient", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 90, unknownLemmas: 3, learningWords: 1 },
  { id: 203, title: "Book of Ruth", author: "Unknown", language: "Hebrew", level: "A2", era: "Ancient", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 55, unknownLemmas: 65, learningWords: 12 },
  { id: 204, title: "Genesis", author: "Moses (Trad.)", language: "Hebrew", level: "B1", era: "Ancient", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 48, unknownLemmas: 180, learningWords: 45 },
  { id: 205, title: "Psalms", author: "David & Others", language: "Hebrew", level: "B2", era: "Ancient", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 40, unknownLemmas: 250, learningWords: 60 },
  { id: 206, title: "Isaiah", author: "Isaiah", language: "Hebrew", level: "C1", era: "8th c. BC", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 25, unknownLemmas: 450, learningWords: 90 },
  { id: 207, title: "Job", author: "Unknown", language: "Hebrew", level: "C2", era: "Ancient", image: "https://images.unsplash.com/photo-1509021436665-8f07dbf5bf1d?auto=format&fit=crop&q=80&w=400", knownCoverage: 15, unknownLemmas: 600, learningWords: 120 },
