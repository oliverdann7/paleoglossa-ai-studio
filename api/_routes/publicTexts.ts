...
router.post(
  '/api/public/texts/:textId/report',
  requireAuth as any,
...
router.post(
  ...
  async (req: AuthenticatedRequest, res: any) => {
    ...
    try {
      ...
      if (!snap.exists)
        return res.status(404).json({ error: 'Import not found', code: 'NOT_FOUND' });
